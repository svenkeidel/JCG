...
object CommandlineParser {
    val ALL_JAVA_ADAPTERS: List[JavaTestAdapter] = List(DoopAdapter, OpalJCGAdatper, SootJCGAdapter, SootUpJCGAdapter, /*SenecaJCGAdapter,*/ TaieJCGAdapter, WalaJCGAdapter, ValueCG_JCG_Adapter)
